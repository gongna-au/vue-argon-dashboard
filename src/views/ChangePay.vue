          ...
          <ul class="list-group">
            <li v-for="parking in parkingList" :key="parking.id" class="list-group-item border-0 d-flex mb-2 bg-gray-100 border-radius-lg">
              <div class="d-flex flex-column flex-grow-1">
                ...
                <span class="text-xs">目前收费标准: <span class="text-dark ms-sm-2 font-weight-bold">{{ parking.charge }}  $</span></span>
              ...
              <!-- 新增的退出登录按钮列 -->
                <div class="col d-flex justify-content-end">
                    <button @click="toggleReservationCard(parking)" class="btn btn-success">修改收费标准</button>
                </div>
              </div>
